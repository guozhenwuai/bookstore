...
<body onload="showImg()">
	<%
		...
		if (request.getAttribute("categories") != null) {
			categories = (Map<String,Integer>) request.getAttribute("categories");
		}
	%>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
				...
				<h4>Categories</h4>
				<br>
                <div class="list-group" id="book_category">
                <%
					for (Map.Entry<String, Integer> entry : categories.entrySet()) {
						String category = entry.getKey();
						Integer count = entry.getValue();
				%>
                    <a href="category?category=<%=category %>" class="list-group-item"><%=category%>
            ...
            <div class="products-grid col-sm-9" id="book_items">
            <%
		...
		<div class="modal-dialog" style="display:inline-block;width:auto;">
			<div class="modal-content">
            	...
            	<div class="modal-body">
            		...
            		<div class="row">
            			<button class="btn btn-danger" id="book_minus" onclick="minus()" disabled=true>
            				<span class="fa fa-minus"></span>
            			</button>
            			<input id="book_num" class="input-lg" style="width:45px;"/>
